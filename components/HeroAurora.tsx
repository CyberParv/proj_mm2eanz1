...
export default function HeroAurora({
  badge = 'Summer Sale · Up to 40% off',
  headline = 'Everyday essentials, delivered fast',
  subheadline = 'Discover curated home, tech, and lifestyle products with trusted quality and quick shipping.',
